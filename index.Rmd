---
title: "Proyecto Procesamiento"
output: html_document
---

## Carga de bibliotecas

Para iniciar con este proyecto, lo primero que se va a hacer es cargar las bibliotecas.
...
Seguidamente se va a cambiar el nombre de los datos ya existentes.
...
Ahora se va a comenzar graficando en forma de histograma, los diferentes datos.
...
En esta parte lo primero a realizar es crear una nueva variable para luego crear un gráfico en línea.
...
Aquí se va a realizar el procedimiento de los gráficos anteriores, solo que esta vez, en puntos.

```{r}
Trece <- ggplot(Datos_del_proyecto, aes(x= fecha,y= temp_celcius, group = 1))+geom_point(col = "#99CC00")
Catorce <- ggplot(Datos_del_proyecto, aes(x= fecha,y= velo_viento, group = 1))+geom_point(col = "#FF3399")
Quince <- ggplot(Datos_del_proyecto, aes(x= fecha,y= evapotran, group = 1))+geom_point(col = "#CC0000")
Dieciseis <- ggplot(Datos_del_proyecto, aes(x= fecha,y= irradiac, group = 1))+geom_point(col = "#CCCCFF")
Diecisiete <- ggplot(Datos_del_proyecto, aes(x= fecha,y=lluvia, group = 1))+geom_point(col = "#003366")
Dieciocho <- ggplot(Datos_del_proyecto, aes(x= fecha,y= HumeRela, group = 1))+geom_point(col = "#669900")

grid.arrange(Trece,Catorce,Quince,Dieciseis,Diecisiete,Dieciocho,nrow = 3, ncol = 2)
```
